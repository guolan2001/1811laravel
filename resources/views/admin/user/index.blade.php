    ...
    <div class="page">
        ...
        <div class="connoisseur">
            <div class="conform">
                <form>
                    <div class="cfD">
                        <input class="userinput" ype="text" name="user_name" value="{{$query['user_name']??''}}" placeholder="请输入名称"/><button>搜索</button>
                        <button class="userbtn" ><a href="/user/add">添加</a></button>
                    </div>
                </form>
            ...
            <div class="conShow">
                <table border="1" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="400px" class="tdColor">管理员邮箱</td>

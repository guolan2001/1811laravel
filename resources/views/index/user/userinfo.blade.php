...
<div class="maincont">
    ...
    <ul class="userNav">
        <li><span class="glyphicon glyphicon-list-alt"></span><a href="/index/order/index">我的订单</a></li>
        ...
        <div class="state">
            ...
            <dl>
                <dt><a href="/index/order/index"><img src="/index/images/user4.png" /></a></dt>
                <dd><a href="/index/order/index">全部订单</a></dd>
            </dl>
            <div class="clearfix"></div>
        </div><!--state/-->
        <li><span class="glyphicon glyphicon-usd"></span><a href="quan.html">我的优惠券</a></li>
        <li><span class="glyphicon glyphicon-map-marker"></span><a href="/index/address/index">收货地址管理</a></li>
